...
// func NewAgentSuite(t *testing.T, keys map[string]*keys.X25519KeyPair) *AgentSuite {
// 	a := new(AgentSuite)
// 	a.Data = &agent.Data{}
// 	a.Data.Keys = keys
...
// func (a *AgentSuite) GetAgentAuthenticator(t *testing.T) error {
...
// func TestHopClientExtAgentAuthenticator(t *testing.T) {
// 	thunks.SetUpTest()
// 	t.Run("connect", func(t *testing.T) {
// 		s := NewSuite(t)
...
// 		keys := make(map[string]*keys.X25519KeyPair)
// 		keys["home/username/.hop/"+common.DefaultKeyFile] = clientKey

// 		a := NewAgentSuite(t, keys)

...
% \vspace{2ex}
        ...
        \begin{small}
            ...
            \begin{bytefield}[bitwidth=7pt,bitheight=15pt]{32}
                ...
                \colorbitbox{lightgreen}{8}{ Channel ID } &
                    ...
                    \colorbitbox{lightgreen}{1}{\rotatebox{90}{\tiny ACK}} &
                    \colorbitbox{lightgreen}{1}{\rotatebox{90}{\tiny FIN}} &
                \colorbitbox{lightgreen}{4}{ 0x0 } &
                \colorbitbox{lightgreen}{16}{Data Size} \\
                \colorbitbox{lightgreen}{16}{Max. Frame Size} & 
                \colorbitbox{lightgreen}{16}{Window Size} \\
                \colorbitbox{lightgreen}{8}{Channel Type} & 
                \colorbitbox{lightgreen}{24}{0x0} \\
                \colorwordbox{lightgreen}{2}{Frame Number (8 bytes)} \\ 
                \colorwordbox{lightgreen}{2}{Acknowledgment Number (8 bytes)} \\ 
    ...
    \caption{\textbf{SSTP Transport Message}---
                The channel frame (green) is the Encrypted Data segment of the transport message.}
    \vspace{-5pt}
\end{figure}

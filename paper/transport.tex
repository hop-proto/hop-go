...
The server chooses a random unique 4 byte opaque string as the Session ID, and
absorbs the Server Authentication message type (\texttt{0x4}), reserved bytes,
and the Session ID. It encrypts the leaf and intermediate certificate with the
duplex state

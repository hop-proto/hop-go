...
attacks. A MAC is squeezed from the duplex object and appended to the Client Hello+Authentication
message (Figure~\ref{fig:client_auth_hidden}).

When the server receives the Client Hello+Authentication message, it instantiates its own duplex
...
static, and uses the duplex material to decrypt the client's static public key.

...
def run_hop_rsync(h1, file_size, bw):
    cmd = f'rsync --no-compress --info=progress2 --rsh="/usr/bin/hop -C ./client_config.toml root@10.0.3.10" ./{file_size}_file :/tmp/file/'
...
def run_tests():
    ...
    with open(output_file, 'a') as file:
        for config in network_configs:
            ...
            h3.cmd("/usr/bin/hopd -C ./server_config.toml &")
